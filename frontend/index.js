...
async function moduleProject4() {
  ...
  document.querySelector('#citySelect').addEventListener('change', async evt =>{
    ...
    try{
      document.querySelector('#citySelect').setAttribute('disable', 'disabled')
      ...
      document.querySelector('#apperentTemp div:nth-child(2)')
      .textContent = `${data.current.apparent_temperature}`
      document.querySelector('#todayDesciption')
